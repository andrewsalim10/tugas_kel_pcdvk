...
### ### ###
class Holdout_Workflow_CV(Basic_Workflow_CV):
    def run_workflow(self,
                     versi, model, str_to_num,
        ...
        if not dataset_list is None:
            ...
            train_loader = DataLoader(train_data, batch_size=batch_size, shuffle=False, num_workers=5)
        ...
        if not dataset_list2 is None:
            train_loader = DataLoader(dataset_list2[0], batch_size=batch_size, shuffle=False, num_workers=5)
